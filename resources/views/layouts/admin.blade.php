...
<head>
    ...
    <title>Abdo-Shop - Dashboard</title>
    ...
    <div class="flex flex-col md:flex-row">
                ...
                <ul class="flex flex-row px-1 py-0 text-center list-reset md:flex-col md:py-3 md:px-2 md:text-left">
                    <li class="flex-1 mr-3">
                        <a href="{{ route('users.index') }}"
                            ...
                            <i class="pr-0 fas fa-users md:pr-3"></i><span
                                class="block pb-1 text-xs text-gray-600 md:pb-0 md:text-base md:text-gray-400 md:inline-block">Users</span>
                        </a>
                    </li>
                    <li class="flex-1 mr-3">
                        <a href="{{ route('products.index') }}"
                            ...
                            <i class="pr-0 fa fa-envelope md:pr-3"></i><span
                                class="block pb-1 text-xs text-gray-600 md:pb-0 md:text-base md:text-gray-400 md:inline-block">Products</span>
                        </a>
                    </li>
                    <li class="flex-1 mr-3">
                        <a href="{{ route('categories.index') }}"
                            ...
                            <i class="pr-0 text-blue-600 fas fa-chart-area md:pr-3"></i><span
                                class="block pb-1 text-xs text-white md:pb-0 md:text-base md:text-white md:inline-block">Categories</span>
                        </a>
                    </li>
                    <li class="flex-1 mr-3">
                        <a href="{{ route('posts.index') }}"
                            ...
                            <i class="pr-0 fa fa-file-alt md:pr-3"></i><span
                                class="block pb-1 text-xs text-gray-600 md:pb-0 md:text-base md:text-gray-400 md:inline-block">Posts</span>
                        </a>
                    </li>
                    <li class="flex-1 mr-3">
                        <a href="{{ route('comments.index') }}"
                            class="block py-1 pl-0 text-white no-underline align-middle border-b-2 border-gray-800 md:py-3 md:pl-1 hover:text-white hover:border-red-500">
                            <i class="pr-0 far fa-comments md:pr-3"></i><span
                                class="block pb-1 text-xs text-gray-600 md:pb-0 md:text-base md:text-gray-400 md:inline-block">Comments</span>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="flex-1 pb-24 mt-12 bg-gray-100 main-content md:mt-2 md:pb-5">
            ...
            @if (session()->has('success'))
                <div id="flash_msg" class="fixed p-4 font-bold text-white bg-blue-500 rounded-lg bottom-4 right-4">
